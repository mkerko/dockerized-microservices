...
@EnableJpaRepositories(basePackages = {"com.test.warehouse"}, transactionManagerRef = "jpaTransactionManager")
@EnableJpaAuditing
@ComponentScan({"com.test.warehouse"})
public class PersistenceConfig {

    private static final String DOMAIN_PATH = "com.test.warehouse.domain";
