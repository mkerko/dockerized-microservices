package com.test.store.warehouse.task;

import com.fasterxml.jackson.databind.ObjectMapper;
import com.test.store.domain.dto.WarehouseItemDTO;
import com.test.store.exception.WarehouseServiceUnavailableException;
import com.test.store.exception.WrongParameterException;
import com.test.store.warehouse.WarehouseClient;
