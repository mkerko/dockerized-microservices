...
@EnableJpaRepositories(basePackages = {"com.test.store"}, transactionManagerRef = "jpaTransactionManager")
@ComponentScan({"com.test.store"})
public class PersistenceConfig {

    private static final String DOMAIN_PATH = "com.test.store.domain";
